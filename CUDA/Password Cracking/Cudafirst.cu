...
/**************************************************************************
  ...
  Compile and run with:
    nvcc -o 2initialfourdigit 2initialfourdigit.cu
...
__device__ int is_a_match(char *attempt) {
  char plain_password1[] = "CV7800";
  char plain_password2[] = "FT8324";
  char plain_password3[] = "HR2335";
  char plain_password4[] = "SA3221";
