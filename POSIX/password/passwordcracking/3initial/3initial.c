...
//Note:Following is the hash value of NIR13
"$6$KB$OCzhWEgikvhifBgbeH/oVOsgheukd/ZYEcZ9gxPOPnuDIfQbz9PDC0O3w3vGDr6top1CMx6rRp3JWjDcDCRko0",
...
struct timespec start, finish;
  ...
  time_diff(&start, &finish, &difference);
